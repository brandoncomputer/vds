...
"@
$winhost = (presentation create "wpf test" wpftest 0 0 800 600)
$winhost.Content = presentation page $page
...
$LayoutListBox.add_MouseUp({$cc.Children.Clear();
$cc.Children.Add([System.Windows.UIElement] (presentation page $TextBox1.Text))})
...
$rPreview.add_Click({
    (presentation findname $MainGrid 'CodeRow').Height = 0
    (presentation findname $MainGrid 'PreviewRow').Height = '*'
})
$rXaml.add_Click({(presentation findname $MainGrid 'PreviewRow').Height = 0
(presentation findname $MainGrid 'CodeRow').Height = '*'})

$rSplit.add_Click({(presentation findname $MainGrid 'PreviewRow').Height = '*'
(presentation findname $MainGrid 'CodeRow').Height = '*'})
dialog showmodal $winhost
